...
export default class NextMatch extends Component {
  ...
  render() {
    ...
    const nextMatchClassName = classnames({
      checked: this.props.nextMatch.checked,
      private: this.props.nextMatch.private,
    });
    ...
    return (
      <div className="nextMatch-div">
        <center>
          ...
          <p>
          <Button bsStyle="danger" className="delete" onClick={this.deleteThisNextMatch.bind(this)}>
            DELETE
          </Button>
          </p>
        </center>
